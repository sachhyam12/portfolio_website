...
const About = () => {
  return (
    <section
      id="about"
      className="py-4 px-[7vw] md:px-[7vw] lg:px-[10vw] font-sans mt-5 md:mt-10 lg:mt-10"
    >
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          ...
          <p className="text-base sm:text-lg md:text-lg text-gray-400 mb-10 mt-8 leading-relaxed">
            ...
            building scalable web applications through projects. Skilled in both
          ...
          {/* Resume Button */}
          <a
            href="https://drive.google.com/file/d/1d4n2ERj_dsHYSokS1UZ4JAGUZQztOJxH/view?usp=sharing"
            target="_blank"
